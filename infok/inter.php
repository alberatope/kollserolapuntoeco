...
<body onload="alcat();carga('<?=$_GET['d']?>');"><!--Cuadro visible en la recarga:-->
...
<?include 'cabecerakolectivos.html';?>

<table width="90%" border="0" style="border-collapse:collapse;max-width:1024px" align="center"><tr><td>
